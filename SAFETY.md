...
- **Motion is optional.** The OS "reduce motion" setting is honoured
  ...
  Lane Dash, Which Cup? and Fruit Catch are the games whose play *is*
  movement — a course has to scroll, a cup has to be followed, fruit has to
  fall — so there it takes away everything decorative instead: no spin when
  the runner trips or the car bumps, no shuffling legs, no shaking basket.
  Which Cup? has nothing decorative to take: its cups slide slowly, never
